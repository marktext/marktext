...
| ---------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [<img src="../assets/sponsors/stardesk.png" width="150">](https://stardesk.onelink.me/p0R7/kpq1jksx) | [デスクを離れても、ワークフローは止まらない。StarDesk は開発用 PC にどこからでもアクセスできる無料のリモートデスクトップです。iOS、Android、ブラウザから自分のパソコンに接続して、Markdown の編集、ターミナルコマンドの実行、ドキュメントの確認、中断した作業の再開ができます。](https://stardesk.onelink.me/p0R7/kpq1jksx) |
