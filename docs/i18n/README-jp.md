...
<td align="left"><a href="https://serpapi.com/?utm_source=marktext">高速で使いやすく完全な API で Google や他の検索エンジンからデータを取得できます。</a></td>
</tr>
<tr>
<td width="182"><a href="https://stardesk.onelink.me/p0R7/kpq1jksx"><img src="../assets/sponsors/stardesk.png" width="150"></a></td>
<td align="left"><a href="https://stardesk.onelink.me/p0R7/kpq1jksx">デスクを離れても、ワークフローは止まらない。StarDesk は開発用 PC にどこからでもアクセスできる無料のリモートデスクトップです。iOS、Android、ブラウザから自分のパソコンに接続して、Markdown の編集、ターミナルコマンドの実行、ドキュメントの確認、中断した作業の再開ができます。</a></td>
</tr>
</table>
