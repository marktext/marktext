...
| ---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [<img src="../assets/sponsors/stardesk.png" width="150">](https://stardesk.onelink.me/p0R7/kpq1jksx) | [離開工位，工作流照常運轉。StarDesk 是一款免費的遠端桌面工具，讓你隨時隨地存取自己的開發電腦。透過 iOS、Android 或網頁端連線自己的電腦，編輯 Markdown、執行終端機指令、審閱文件，或接著上次中斷的地方繼續。](https://stardesk.onelink.me/p0R7/kpq1jksx) |
