...
onMounted(() => {
  ...
  // on every document mutation (`doc` and `prevDoc` are memoized lazy
  // snapshots of the state immediately after and before that mutation); the desktop's content-change pipeline wants the
