...
// sandboxed bundling.
// jison's UMD `exports.parser/Parser/parse` fallback was also dropped: this
// file is an ESM module (`export default Diagram`), so the CommonJS `exports`
// global is undefined here and Rollup flags it (COMMONJS_VARIABLE_IN_ESM).
// `Diagram.parse` uses the internal `parser` directly, so nothing relies on it.
/**
