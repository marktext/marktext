...
| showHeadingFoldChevrons            | Boolean | `false`            | Always show heading fold chevrons in the WYSIWYG editor, instead of only showing them on the active, hovered, or folded heading line.                                             |
