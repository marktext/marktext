...
/**
 * (c) 2019 Sukka <https://skk.moe>
 * https://github.com/you-dont-need/You-Dont-Need-Lodash-Underscore#_extend
 * https://github.com/you-dont-need/You-Dont-Need-Lodash-Underscore/pull/244
 * https://github.com/hexojs/hexo/pull/3969
 */
...
function wobble(x1, y1, x2, y2) {
  assert([x1, x2, y1, y2].some(Number.isFinite), 'wobble requires finite arguments');
...
function handRect(x, y, w, h) {
  assert([x, y, w, h].some(Number.isFinite), 'handRect requires finite arguments');
  return 'M' + x + ',' + y +
    wobble(x, y, x + w, y) +
...
function handLine(x1, y1, x2, y2) {
  assert([x1, y1, x2, y2].some(Number.isFinite), 'x1,x2,y1,y2 must be numeric');
...
extend(BaseTheme.prototype, {
  ...
  layout: function () {
    ...
    actors.forEach(a => {
      ...
      a.distances.forEach(([distance, b]) => {
  ...
  drawSignals: function (offsetY) {
    var y = offsetY;
    this.diagram.signals.forEach(s => {
...
if (typeof Snap != 'undefined') {
  ...
  extend(SnapTheme.prototype, BaseTheme.prototype, {
  ...
  extend(SnapHandTheme.prototype, SnapTheme.prototype, {
    drawLine: function (x1, y1, x2, y2, linetype, arrowhead) {
...
Diagram.prototype.drawSVG = function (container, options) {
  ...
  var div = (container && typeof container === 'string') ? document.getElementById(container) : container;
