<template>
  <transition name="shadow">
    <div class="title-bar"
         :class="[{ 'active': active }, theme, isTopDialogShown ? 'shadow' : 'noShadow']"
    >
      <div id="bar">
      ...
      <span v-for="(path, index) of paths" :key="index">
        ...
        <div :class="platform === 'win32' ? 'left-toolbar' : 'right-toolbar'">
          <div v-if="platform === 'win32'" class="windows-titlebar-menu title-no-drag" @click.stop="handleMenuClick">
            &#9776;
          </div>
          <div
              class="word-count"
